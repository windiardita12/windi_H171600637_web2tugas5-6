				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<label class="col-md-8 col-from-label text-md-left">{!! $Kategorigaleri->created_at !!}</label>
						</div>

						<div class="form-group row">
							<label class="col-md-4 col-from-label text-md-right">Update</label>
							<label class="col-md-8 col-from-label text-md-left">{!! $Kategorigaleri->updated_at !!}</label>
						</div>
